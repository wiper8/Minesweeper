...
#'
#' @examples
random_clicker <- function(grid, global_cache, clusters_cache, ...) {
  ...
  list(list(i_to_position(next_i, dim(grid)), TRUE, "random"), global_cache = global_cache, clusters_cache = clusters_cache)
}
