...
get_prob(n = 1000, total_mines = 55, c(17, 9))
get_prob(n = 1000, total_mines = 56, c(17, 9))
...
get_first_click_probs(n = 1000, total_mines = 4, dims = c(4, 4)) |> show_first_click_probs(legend_type = TRUE)
