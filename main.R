...
get_prob(n = 500, total_mines = 7, c(10, 8)) # begginner
get_prob(n = 250, total_mines = 15, c(14, 9)) # easy
get_prob(n = 150, total_mines = 40, c(20, 15)) # intermediate
get_prob(n = 50, total_mines = 99, c(26, 19)) # expert
