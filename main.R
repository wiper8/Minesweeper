...
set.seed(2026L)
compute_probs_success(n = 200, total_mines = 40, c(17, 9), certain_else_random_clicker) # ~7 minutes
compute_probs_success(n = 200, total_mines = 56, c(17, 9), certain_else_random_clicker) # ~4 minutes

# graphique de la probabilité de succès selon le nombre de mines
set.seed(2026L)
show_mines_difficulty(compare_clickers(n = 200, c(6, 4))) # ~11 minutes
show_mines_difficulty(compare_clickers(n = 200, c(17, 9))) # ~6 heures
